...
import { createNftSchema, generateImageSchema, generatePromptSchema, updateNftSchema } from "./dto/nft.schema.js";
...
router.post("/:id/list", asyncHandler(controller.listOnMarketplace));
